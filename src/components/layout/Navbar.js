              ...
              <ul className="navbar-nav ms-auto mb-2 mb-lg-0">
                {loggedInNav ? (
                  <ul className="navbar-nav ms-auto mb-2 mb-lg-0">
                    ...
                    <li className="nav-item">
                      <NavLink className="nav-link" to="/reduxa">
                        Redux
                      </NavLink>
                    </li>
                    {/* <li className="nav-item">
                  ...
                  <ul className="navbar-nav ms-auto mb-2 mb-lg-0">
                    ...
                    <li className="nav-item">
                      <NavLink className={(location.pathname === "/reduxb") || (location.pathname === "/reduxc") ? "nav-link active" : "nav-link"} to="/reduxa">
                        Services
                      </NavLink>
                    </li>
                    <li className="nav-item">
                      <NavLink className={(location.pathname === "/add-user") || (location.pathname === "/userlist/edit-user/:id") || (location.pathname === "/userlist/view-user/:id") ? "nav-link active" : "nav-link"} to="/userlist">
                        User List
                      </NavLink>
                    </li>
                    <li className="nav-item">
